 ...
 */
const AppConfig = {
   appLogo: require('Assets/img/logoini.png'),          // App Logo
   brandName: 'Bloomtech',                                    // Brand Name
   ...
   copyRightText: 'Copyright © 2021 Powered by IAServitech Soluciones Inteligentes.',      // Copy Right Text
   // light theme colors
   themeColors: {
      'primary': '#5D92F4',
      'secondary': '#677080',
