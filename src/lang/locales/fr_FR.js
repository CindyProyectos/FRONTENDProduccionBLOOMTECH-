module.exports = {
   ...
   "sidebar.reports": "rapports",//desde aqui
   "sidebar.parameters": "paramètres",
   "sidebar.catalogs": "catalogues",
   "sidebar.users": "utilisateurs",
   "sidebar.profiles": "profils",
   "sidebar.packages": "paquets",
   "sidebar.refer": "référer",
   "sidebar.bonus": "prime",
   "sidebar.buyPackages": "acheter des forfaits",
   "sidebar.wallet": "portefeuille",
   "sidebar.realTimePrices": "Prix en temps réel",
   "sidebar.buyCoins": "acheter des pièces",
   "sidebar.currencyBalance": "Solde en devises",
   "sidebar.futures": "à terme"
}