module.exports = {
   ...
   "sidebar.reports": "отчеты",//desde aqui
   "sidebar.parameters": "отчеты",
   "sidebar.catalogs": "отчеты",
   "sidebar.users": "отчеты",
   "sidebar.profiles": "отчеты",
   "sidebar.packages": "отчеты",
   "sidebar.refer": "отчеты",
   "sidebar.bonus": "отчеты",
   "sidebar.buyPackages": "отчеты",
   "sidebar.wallet": "отчеты",
   "sidebar.realTimePrices": "отчеты",
   "sidebar.buyCoins": "отчеты",
   "sidebar.currencyBalance": "отчеты",
   "sidebar.futures": "отчеты"
}