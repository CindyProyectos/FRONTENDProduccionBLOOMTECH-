module.exports = {
   ...
   "sidebar.crm": "CRM",
   "sidebar.dashboard": "Irányítópult",
   "widgets.transactionList": "tranzakciós lista",
   "widgets.transferReport": "átutalási jelentés",
   "widgets.expenseCategory": "költségkategória",
   "widgets.upcomingEvents": "Közelgő események",
   "widgets.OngoingProjects": "folyamatban lévő projektek",
   "widgets.ProjectStatus": "Projekt állapota",
   "widgets.LiveChatSupport": "élő chat-támogatás",
   "sidebar.projects": "projektek",
   "sidebar.projectDetail": "project részletek",
   "sidebar.clients": "ügyfelek",
   "sidebar.reports": "jelentések",//desde aqui
   "sidebar.parameters": "parametri",
   "sidebar.catalogs": "cataloghi",
   "sidebar.users": "utenti",
   "sidebar.profiles": "profili",
   "sidebar.packages": "Pacchetti",
   "sidebar.refer": "fare riferimento",
   "sidebar.bonus": "bonus",
   "sidebar.buyPackages": "acquista pacchetti",
   "sidebar.wallet": "portafoglio",
   "sidebar.realTimePrices": "Prezzi in tempo reale",
   "sidebar.buyCoins": "comprare monete",
   "sidebar.currencyBalance": "valuta Saldo",
