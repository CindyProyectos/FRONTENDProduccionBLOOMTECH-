module.exports = {
   ...
   "sidebar.crm": "CRM",
   "sidebar.dashboard": "仪表板",
   "widgets.transactionList": "交易清单",
   "widgets.transferReport": "转移报告",
   "widgets.expenseCategory": "费用类别",
   "widgets.upcomingEvents": "接下来的活动",
   "widgets.OngoingProjects": "正在进行的项目",
   "widgets.ProjectStatus": "项目状态",
   "widgets.LiveChatSupport": "实时聊天支持",
   "sidebar.projects": "项目",
   "sidebar.projectDetail": "项目细节",
   "sidebar.clients": "客户",//desde aqui
   "sidebar.parameters": "报告",
   "sidebar.catalogs": "客户",
   "sidebar.users": "客户",
   "sidebar.profiles": "客户",
   "sidebar.packages": "客户",
   "sidebar.refer": "客户",
   "sidebar.bonus": "客户",
   "sidebar.buyPackages": "客户",
   "sidebar.wallet": "客户",
   "sidebar.realTimePrices": "客户",
   "sidebar.buyCoins": "客户",
   "sidebar.currencyBalance": "客户",
   "sidebar.futures": "客户"
}