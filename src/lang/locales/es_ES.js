module.exports = {
   ...
   "components.estado": "Estado",
   "components.telefono": "Teléfono",
   ...
   "components.firstName": "Nombres",
   "components.nombre": "Nombres",
   "components.dni": "DNI",
   ...
   "sidebar.reports": "informes",//desde aqui
   "sidebar.parameters": "parámetros",
   "sidebar.catalogs": "catálogos",
   "sidebar.users": "usuarios",
   "sidebar.profiles": "perfiles",
   "sidebar.packages": "paquetes",
   "sidebar.refer": "referir",
   "sidebar.bonus": "bonos",
   "sidebar.buyPackages": "comprar paquetes",
   "sidebar.wallet": "billetera",
   "sidebar.realTimePrices": "Precios en tiempo real",
   "sidebar.buyCoins": "Comprar monedas",
   "sidebar.currencyBalance": "balance actual",
   "sidebar.futures": "futuros",
   "sidebar.realTime": "precios",
   "sidebar.realTimeTitle": "Precios En Tiempo Real",
   "sidebar.realTimeTable.title": "Precios",
   "sidebar.realTimeTable.name": "Nombre",
   "sidebar.realTimeTable.price": "Precio",
   "sidebar.construction": "Página en Construcción",
   "sidebar.construction.message": "No te preocupes, este módulo se habilitará próximamente",
   "sidebar.construction.title": "En Construcción",
   "sidebar.construction.paragraph": "Estamos trabajando para ofrecerte la mejor experiencia en el uso de las criptomonedas.",
   "sidebar.panel": "Panel",
   "sidebar.team":"Equipo",
   "sidebar.myteam": "Directo",
   "sidebar.allteam": "Todo el equipo",
   "sidebar.uvad": "UVAD",
   "sidebar.depositar": "Depositar",
   "sidebar.retirar": "Retirar",
   "sibebar.dolar": "USD (Dólar)",
   "components.depositUSD": "Ingrese el monto del depósito (USD)",
   "components.receive": "Recibes UVAD",
   "widgets.pay": "Pagar",
   "widgets.preview": "Previo",
   "components.uvadbalance": "Balance UVAD",
   "components.uvadretiro": "Monto a retirar (UVAD)",
   "sidebar.usuario": "Usuarios",
   "sidebar.addusers": "Agregar Usuarios",
   "sidebar.listusers": "Listar Usuarios",
   "sidebar.wallet.customerInformation": "Información de Cliente",
   "sidebar.customerInformation": "Información de Cliente",
   "sidebar.bitcoin": "bitcoin",
   "sidebar.ethereum": "ethereum",
   "sidebar.wallet.bitcoin": "Bitcoin",
   "sidebar.wallet.bitcoin.title": "Billetera Bitcoin",
   "sidebar.wallet.ethereum": "Ethereum",
   "sidebar.wallet.ethereum.title": "Billetera Ethereum",
   "sidebar.wallet.uvad": "UVAD",
   "sidebar.wallet.uvad.title": "Billetera UVAD",
   "sidebar.deposit": "Deposit",
   "sidebar.deposit.bitcoin": "Depositar Bitcoin",
   "sidebar.deposit.ethereum": "Depositar Ethereum Deposit",
   "sidebar.deposit.bnb": "Depositar BNB",
   "sidebar.deposit.uvad": "Depositar UVAD",
   "sidebar.withdraw": "Retirar",
   "sidebar.withdraw.uvad": "Retirar UVAD",
   "sidebar.convert": "Convertir",
   "sidebar.history": "Historial",
   "sidebar.convert.convert": "Convertir",
   "sidebar.convert.history": "Historial",
   "components.depositBTC": "Ingrese el monto del depósito (BTC)",
   "components.depositETC": "Ingrese el monto del depósito (ETC)",
   "components.depositBNB": "Ingrese el monto del depósito (BNB)",
   "components.depositUVAD": "Ingrese el monto del depósito (UVAD)",
   "components.addnormaluser": "Agregar usuario normal",
   "components.addsponsoruser": "Agregar usuario Sponsorizado",
