...
export const SIGNUP_USER_AUTH_SUCCESS = 'SIGNUP_USER_AUTH_SUCCESS';
export const SIGNUP_USER_AUTH_FAILURE = 'SIGNUP_USER_AUTH_FAILURE';
export const SIGNUP_USER_SPONSOR = 'SIGNUP_USER_SPONSOR';
export const SIGNUP_USER_SPONSOR_SUCCESS = 'SIGNUP_USER_SPONSOR_SUCCESS';
export const SIGNUP_USER_SPONSOR_FAILURE = 'SIGNUP_USER_SPONSOR_FAILURE';
...
export const LOGIN_USER_BLOOMTECH = 'LOGIN_USER_BLOOMTECH';
...
export const SIGNUP_USER_BLOOMTECH = 'SIGNUP_USER_BLOOMTECH';
export const SIGNUP_USER_BLOOMTECH_SUCCESS = 'SIGNUP_USER_BLOOMTECH_SUCCESS';
export const SIGNUP_USER_BLOOMTECH_FAILURE = 'SIGNUP_USER_BLOOMTECH_FAILURE';
export const SIGNUP_USER_NORMAL = 'SIGNUP_USER_NORMAL';
...
// Real time pricing bloomtech
export const REAL_TIME_PRICING_BTC = 'REAL_TIME_PRICING_BTC';
export const REAL_TIME_PRICING_ETH = 'REAL_TIME_PRICING_ETH';
export const REAL_TIME_PRICING_BNB = 'REAL_TIME_PRICING_BNB';
