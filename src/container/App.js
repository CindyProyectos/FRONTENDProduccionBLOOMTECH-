...
import AppSignInBloomtech from './SigninBloomtech';
import AppSignUp from './SignupFirebase';
import AppRegisterSponsor from './RegisterSponsor';
import AppNotPassword from './NotPassword';
// API bloomtech sinhup
import AppSignUpBloomtechApi from './SignupBloomtechApi';
...
class App extends Component {
   ...
   render() {
      ...
      if (location.pathname === '/') {
         if (user === null) {
            return (<Redirect to={'/signinbloomtech'} />);
         } else {
            return (<Redirect to={'/app/home/main'} />);
         }
      }
      return (
         <RctThemeProvider>
            ...
            <Route path="/signinBloomtech" component={AppSignInBloomtech} />
            <Route path="/signup" component={AppSignUp} />
            <Route path="/registersponsor" component={AppRegisterSponsor} />
            <Route path="/notpassword" component={AppNotPassword} />
            <Route path="/signupbloomtech" component={AppSignUpBloomtechApi} />
