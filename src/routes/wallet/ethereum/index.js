     ...
     render() {
         ...
         return (
             <div className="table-wrapper">
                 <PageTitleBar title={<IntlMessages id="sidebar.wallet.ethereum.title" />} match={match} />
                 <Form>
                    <FormGroup row>
                        <div className="help-text d-flex p-10">
                            <i className="ti-info-alt mr-15 pt-5"></i>
                            <span>The wallet key must be in (ETC).</span>
                        </div>
                        <div>
                    ...
                    <FormGroup row>
                        <Label for="receive" sm={3}><IntlMessages id="sidebar.wallet.ethereum.title" /></Label>
                        <Col sm={9}>
