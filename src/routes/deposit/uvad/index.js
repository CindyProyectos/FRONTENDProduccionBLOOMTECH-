 ...
 */
 ...
 class DepositUVAD extends Component {
     ...
     render() {
         ...
         return (
             <div className="table-wrapper">
                 <PageTitleBar title={<IntlMessages id="sidebar.deposit.uvad" />} match={match} />
                 <Form>
                    <FormGroup row>
                        <div className="help-text d-flex p-10">
                            <i className="ti-info-alt mr-15 pt-5"></i>
                            <span>The deposit to be made must be in (UVAD).</span>
                        </div>
                        <div>
                    ...
                    <FormGroup row>
                        <Label for="depositUSD" sm={3}><IntlMessages id="components.depositUVAD" /></Label>
                        <Col sm={9}>
