 ...
 */
 ...
 class DepositEthereum extends Component {
     ...
     render() {
         ...
         return (
             <div className="table-wrapper">
                 <PageTitleBar title={<IntlMessages id="sidebar.deposit.ethereum" />} match={match} />
                 <Form>
                    <FormGroup row>
                        <div className="help-text d-flex p-10">
                            <i className="ti-info-alt mr-15 pt-5"></i>
                            <span>The deposit to be made must be in (ETC).</span>
                        </div>
                        <div>
                            <img src={require(`Assets/img/ethereum.png`)} height="55" />
                        </div>
                    </FormGroup>

                    <FormGroup row>
                        <Label for="depositUSD" sm={3}><IntlMessages id="components.depositETC" /></Label>
                        <Col sm={9}>
 ...
 export default DepositEthereum;