...
// Table Real Time Pricing Bloomtech
const AsyncPricingTableComponent = Loadable({
   loader: () => import("Routes/tables/real-time-pricing"),
   loading: () => <RctPageLoader />,
});

// Page Under Construction
const AsyncPageUnderConstruction = Loadable({
   loader: () => import("Routes/pages/construction"),
   loading: () => <RctPageLoader />,
});

// Page Under Home Main
const AsyncHomePage = Loadable({
   loader: () => import("Routes/home/main"),
   loading: () => <RctPageLoader />,
});

// Page Panel
const AsyncPanelPage = Loadable({
   loader: () => import("Routes/pages/panel"),
   loading: () => <RctPageLoader />,
});


// Directo
const AsyncMyTeamPage = Loadable({
   loader: () => import("Routes/pages/myteam"),
   loading: () => <RctPageLoader />,
});
// Todo el equipo
const AsyncAllTeamPage = Loadable({
   loader: () => import("Routes/pages/allteam"),
   loading: () => <RctPageLoader />,
});
//depositos
const AsyncDepositUSDPage = Loadable({
   loader: () => import("Routes/pages/depositusd"),
   loading: () => <RctPageLoader />,
});
//transacciones
const AsyncWithdrawPage = Loadable({
   loader: () => import("Routes/pages/withdraw"),
   loading: () => <RctPageLoader />,
});
//add users
const AsyncAddUsersPage = Loadable({
   loader: () => import("Routes/pages/addusers"),
   loading: () => <RctPageLoader />,
});
//list users
const AsyncListUsersPage = Loadable({
   loader: () => import("Routes/pages/listusers"),
   loading: () => <RctPageLoader />,
});

const AsyncCustomerInformationComponent = Loadable({
   loader: () => import("Routes/wallet/customer-information"),
   loading: () => <RctPageLoader />,
});

// BITCOIN - Wallet
const AsyncWalletBTCComponent = Loadable({
   loader: () => import("Routes/wallet/bitcoin"),
   loading: () => <RctPageLoader />,
});

// ETHEREUM - Wallet
const AsyncWalletETHComponent = Loadable({
   loader: () => import("Routes/wallet/ethereum"),
   loading: () => <RctPageLoader />,
});

// UVAD - Wallet
const AsyncWalletUVADComponent = Loadable({
   loader: () => import("Routes/wallet/uvad"),
   loading: () => <RctPageLoader />,
});

// BITCOIN - Deposit
const AsyncDepositBitcoinComponent = Loadable({
   loader: () => import("Routes/deposit/bitcoin"),
   loading: () => <RctPageLoader />,
});

// ETHEREUM - Deposit
const AsyncDepositEthereumComponent = Loadable({
   loader: () => import("Routes/deposit/ethereum"),
   loading: () => <RctPageLoader />,
});

// BNB - Deposit
const AsyncDepositBNBComponent = Loadable({
   loader: () => import("Routes/deposit/bnb"),
   loading: () => <RctPageLoader />,
});

// UVAD - Deposit
const AsyncDepositUvadComponent = Loadable({
   loader: () => import("Routes/deposit/uvad"),
   loading: () => <RctPageLoader />,
});

const AsyncConvertComponent = Loadable({
   loader: () => import("Routes/convert/convert"),
   loading: () => <RctPageLoader />,
});

// Convert / History
const AsyncConvertHistoryComponent = Loadable({
   loader: () => import("Routes/convert/history"),
   loading: () => <RctPageLoader />,
});
