						...
						>
							<div className="user-profile">
								<img
									...
									//src={{uri: 'data:image/jpeg;base64,{localStorage.getItem("fotouser")}'}}
									/*source={{
										uri: `data:image/jpeg;base64,${localStorage.getItem("fotouser")}`,
									 }}*/
									// src = {{
									// 	uri: `data:image/jpeg;base64,${localStorage.getItem("fotouser")}`,
									//  }}
									src={
										(localStorage.getItem("fotouser").endsWith("null") || localStorage.getItem("fotouser") === "" ? require('Assets/avatars/profile.jpg') : localStorage.getItem("fotouser"))
									}
									alt="user profile"
							...
							<div className="user-info">
								<span className="user-name ml-4">{localStorage.getItem("nombreuser")}</span>
						...
						<DropdownMenu>
							<ul className="list-unstyled mb-0">
								<li className="p-15 border-bottom user-profile-top bg-primary rounded-top">
									<p className="text-white mb-0 fs-14">{localStorage.getItem("user")}</p>
									<span className="text-white fs-14">{localStorage.getItem("emailuser")}</span>
								</li>
								<li>
									<Link to={{
